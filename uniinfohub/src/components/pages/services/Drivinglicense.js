    ...
    <div className="driving-page">
      ...
      <div className="content">
        ...
        <section id="applying-for-licence">
          ...
          <p>Any one of the following documents may be used to satisfy the requirement to provide proof of legal name and complete date of birth:
    ...
    margin-bottom: 5px;
        ...
        <section id="licensing-requirements">
          ...
          <div className="g1-container">
            ...
            <p>
                Level One lasts 12 months. The Ministry of Transportation encourages all new drivers to take an
                approved driver-education course to help learn the proper driving skills and knowledge. You should
                begin your training as soon as you become a Level One driver so you can get as much driving experience
                as possible. If you pass an approved course, you can complete Level One in eight months.
            </p>
            ...
            <ul>
                ...
                <li>
                    You must not drive alone; an accompanying driver must sit in the front passenger seat. This is the
                    only person who can be in the front seat with you while you drive. The accompanying driver must
                    have a valid Class G (or higher) licence, at least four years of driving experience and a
                    blood-alcohol level of less than .05% when accompanying you. Time spent at the Class G2 level, as
                    long as the G2 licence was valid (not suspended), does count toward the accompanying driver’s four
                    years of experience. The accompanying driver’s licence may have demerit points, but it cannot be
                    suspended.
                </li>
                <li>Each person in the vehicle must have a working seatbelt.</li>
                <li>
                    You must not drive on 400-series highways with a posted speed limit over 80 km/h. Also, you must
                    not drive on certain high-speed roads including the Queen Elizabeth Way, Don Valley Parkway and the
                    Gardiner Expressway in the Greater Toronto Area, the E.C. Row Expressway in Windsor and the
                    Conestoga Parkway in Kitchener-Waterloo. However, if your accompanying driver is a driving
                    instructor, you may drive on any road.
                </li>
                <li>You must not drive between midnight and 5 a.m.</li>
            </ul>
            <p>
                You must pass a road test of your driving skills to move to Level Two. At this time, you will be given
                a Class G2 licence.
            </p>
          ...
          <div className="level-two-container">
            ...
            <p>
                Level Two lasts at least 12 months. At this level, you have more privileges because of your driving
                experience.
            </p>
            <h3>At Level Two:</h3>
            <ul>
            ...
            <p>
                In addition, the following restrictions apply between the hours of midnight and 5 a.m. to G2 drivers
                aged 19 years and under:
            </p>
            <ul>
                <li>
                    In the first six months after receiving your G2 licence, you are allowed to carry only one
                    passenger aged 19 or under.
                </li>
                <li>
                    After six months with your G2 licence and until you obtain your full G licence or turn 20, you are
                    allowed to carry up to three passengers aged 19 or under.
                </li>
            </ul>
            <h3>Exemptions:</h3>
            <p>
                The passenger restrictions for G2 drivers aged 19 and under do not apply if you are accompanied by a{' '}
                <strong>fully-licensed driver</strong> in the front
                passenger seat, or if the passengers are members of your immediate family (a guardian or those related
                to you by blood, marriage, common-law relationship or adoption).
            </p>
            <p>
                After 12 months at Level Two, you may take a road test to qualify for full licence privileges. You must
                pass this test to get a Class G licence.
            </p>
           
        </div>

          <div className="road-tests-container">
            <h2 id="road-tests">Road tests</h2>
            <p>
                Road tests check your driving skills in the vehicle and in traffic. You will be tested on your ability
                to follow the rules of the road and safe driving practices.
            </p>
            <p>
                When you feel qualified to drive safely and confident enough to take your road test, schedule an
                appointment by internet, phone or in-person at any DriveTest Centre. You can contact the DriveTest
                Centre at <strong>647-776-0331 </strong>or <strong>1-888-570-6110</strong>, or go online to{' '}
            ...
            <p>
                You must bring the appropriate vehicle to your road test. The vehicle must be fit, in proper working
                condition, plated and insured.
            </p>
            <p>
                If you are a Level One driver, an accompanying driver must come with you to the test centre. If you are
                a Level Two driver, be prepared to take alternate transportation home in case you fail your road test
                and are unqualified to drive.
            </p>
            <p>
                No pets or passengers other than the driver examiner are allowed in the vehicle during a road test.
                Driving instructors, friends, relatives and translators may not accompany you during the test.
            </p>
            <p>
                All road tests have a set time frame. Before you begin your test, the examiner will inform you of the
                time you have to complete the test. You will not be asked to do anything illegal during the road test.
                The examiner will explain the test, and you should follow his or her instructions. The examiner is not
                allowed to coach you during the test, so if you have any questions, ask them before you begin.
            </p>
            <p>
                Electronic driving aids such as automatic parallel-parking systems, lane monitoring, cruise control,
                and back cameras may not be used during the road test. On a road test, you are required to demonstrate
                the proper skills in operating a motor vehicle without the reliance of driving aids (for example,
                shoulder checks, mirror checks and so on).
            </p>
            <p>
                At the end of each test, the examiner will give you a complete report of your skills, and explain any
                mistakes you have made. If you fail the test, the report will show you where you need to improve. When
                you have had more practice, you can make an appointment to take the test again. You must wait at least
                10 days between tests.
            </p>
            <h3>G2 exit test – checklist</h3>
            <p>
                You must have highway driving experience (experience driving on highways with speed limits of at least
                80 km/h) before taking the G2 exit test. You must complete a Declaration of Highway Driving Experience
                form, describing the highway driving experience you have, before taking the road test. Bring the
                following items to the test:
            </p>
            <ul>
                <li>
                 
                       <strong> Vehicle in good working order</strong>
