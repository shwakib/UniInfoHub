...
// import '../../../css/OutsideUniBusPass.css';
...
//             <section className="bus-pass-outside-section">
//             {/* Fares, Tickets, Passes Section */}
//             <div className="fares-tickets-section">
...
//                         </tr>
//                         <tr>
//                             {/* <td>Child <br /><small>(12 years and under)*</small></td>
//                             <td>free <br /><small>(See note below.)</small></td> */}
//                             <td>Child </td>
//                             <td>free </td>
//                         </tr>
//                     </tbody>
...
//                 <p className="note">Note: Children 12 years of age and under are free on City service with a full paying passenger. If riding alone, qualifies as youth.</p>
//             </div>
...
//                     <div className="card">
//                         <img src={TW_Smart_Ride} alt="TW Smart Ride" className="card-image" />
//                         <div className="card-details">
//                             <h3>TW Smart Ride</h3>
//                             <ul>
//                                 <li>Loaded with a minimum of <strong>5 rides</strong>.</li>
//                                 <li>Provides an automatic transfer, valid for 2 hours.</li>
//                                 <li>Reloadable and can be used over and over again.</li>
//                             </ul>
//                         </div>
//                     </div>
//                     <div className="card">
//                         <img src={TW_Smart_Pass} alt="TW Smart Pass" className="card-image" />
//                         <div className="card-details">
//                             <h3>TW Smart Pass</h3>
//                             <ul>
//                                 <li>Loaded with a minimum of <strong>15 days</strong>.</li>
//                                 <li>Valid for consecutive days from the first tap on the farebox.</li>
//                                 <li>Reloadable and can be used over and over again.</li>
//                             </ul>
//                         </div>
//                     </div>
...
//             <div className="smart-ride-section">
//                 <h2>Smart Ride</h2>
...
//             </div>
//             {/* Smart Ride Pricing Section */}
//             <div className="smart-Pass-section">
//                 <h2>Smart Pass</h2>
//                 <table className="pricing-table">
//                     <thead>
//                         <tr>
